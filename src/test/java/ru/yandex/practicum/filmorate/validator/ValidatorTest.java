...
class ValidatorTest {
    ...
    public void createFilmWithoutName() {
        Film film = new Film(null, "Описание",
                LocalDate.of(2000, 9, 12), 120);
        ValidationException e = assertThrows(ValidationException.class, () -> ru.yandex.practicum.filmorate.validator.Validator.validateFilm(film));
